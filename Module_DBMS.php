...
final class Module_DBMS extends GDO_Module
{
	...
	public function checkSystemDependencies(): bool
	{
		...
		{
			return $this->errorSystemDependency('err_php_extension', ['odbc']);
		}
		return true;
	}
	...
	public function dbmsFree($result): void
	{
        odbc_free_result($result);
	}

	public function dbmsFetchRow($result): ?array
	{
        return odbc_fetch_row($result);
	}

	public function dbmsFetchAllRows($result): ?array
	{
        $rows = [];
	...
	public function dbmsFetchAssoc($result): ?array
	{
        return odbc_fetch_array($result);
	}

	public function dbmsFetchAllAssoc($result): ?array
	{
        $rows = [];
	...
	{
        $result = $this->dbmsQry("SELECT @@IDENTITY AS LastID");
        return $this->dbmsFetchAssoc($result)['LastID'];
	}
